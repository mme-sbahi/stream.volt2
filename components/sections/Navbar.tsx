        ...
        <div className="px-6 py-4 flex flex-col gap-1">
          {NAV_LINKS.map((link) => (
            <a
              ...
              href={link.href}
              onClick={closeMenu}
              className="py-2.5 px-3 rounded-lg text-[#8a8a8a] hover:text-[#ffffff] hover:bg-white/5 transition-all"
            >
              {link.label}
            </a>
          ))}
          <a href="#pricing" className="btn-primary mt-3 py-3 rounded-xl text-center font-semibold" onClick={closeMenu}>
            Get Started →
          </a>
        </div>
      </div>
